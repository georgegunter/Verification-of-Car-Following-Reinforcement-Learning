...
val standardTSTP : bool ref   (*True = Standard TSTP, False = infix notation, etc.*)
val fullProofs   : bool ref   (*True = include variable instantiations in proofs*)
...
val formulaBodyRelations : formulaBody -> NameAritySet.set

(*TPTP-style printing of terms*)
val ppTerm : mapping -> Term.term Print.pp

val ppFormulaBody : mapping -> formulaBody Print.pp
...
val freeVarsFOFonly : problem -> NameSet.set
