...
local
  ...
  (*The leading zeros eliminate arbitrary ordering changes in non-backtracking splitting,
    for example, 10<9 alphabetically. Now we have 009<010. Affects literal selection.*)
  fun numName i = mkPrefix prefix (StringCvt.padLeft #"0" 6 (Int.toString  i));
in
