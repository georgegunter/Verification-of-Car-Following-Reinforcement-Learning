...
val isGround : literal -> bool

val containsSkolemFunction : literal -> bool
...
val mkBinop : polarity * Atom.relationName -> Term.term * Term.term -> literal
...
val freeSkos : literal -> NameSet.set
